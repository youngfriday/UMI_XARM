...
class FrankaArmInterface:
    def __init__(self):
        self.robot = RobotInterface(ip_address="172.16.0.3")
        print('FrankaArmInterface initialized')
    ...
    def move_to_ee_pose(self, pose, time_to_go):
...
arm_server = zerorpc.Server(FrankaArmInterface())
arm_server.bind("tcp://0.0.0.0:4242")
arm_server.run()